...
//		    System.out.println( sortMaxCommentsByUser(news));
		//    
		//    
		        News news1 = new News(1, "Harika", "Hari", "comment");
		        News news2 =new News(2, "Harika1", "Hari1", "budget");
		        News news3 = new News(1, "Harika2", "Hari2", "comment");
		        News news4 = new News(3, "Harika3", "Hari", "budget");
		        News news5 = new News(1, "Harika4", "Hari2", "comment");
		        News news6 = new News(3, "Harika5", "Hari", "budget");
		        News news7 = new News(1, "Harika6", "Hari6" ,"comment");
