...
public class TransactionsAssign {
    ...
    public static void main(String[] args) {
        Trader t1 = new Trader("Harika", "Bangalore");
        Trader t2 = new Trader("Shyamu", "Pune");
        Trader t3 = new Trader("Anusha", "Bangalore");
        Trader t4 = new Trader("Jhansi", "Delhi");
        Trader t5= new Trader("Devayani", "Chennai");

        Trader t6 = new Trader("Lavayani", "Pune");
        Trader t7 = new Trader("Vasu", "Delhi");
        Trader t8 = new Trader("Kumar", "Delhi");
        Trader t9 = new Trader("Gowtham", "Pune");
